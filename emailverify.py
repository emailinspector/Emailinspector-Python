...
class emailinspectorOne():

    def __init__(self, key, email):
        self.key = key
        self.email = email
        self.verif = "https://app.emailinspector.io/api/verifEmail?secret="
...
class emailinspectorBulk():
    ...
    def __init__(self, key, user_file):
        ...
        self.url = 'https://app.emailinspector.io/api/verifApiFile?secret='+key+'&filename=%s' % self.name
    ...
    def get_info(self):
        ...
        with open('id_file','r') as f:
            ids = f.read()
        url = 'https://app.emailinspector.io/api/getApiFileInfo?secret='+self.key+'&id=%s' % ids
        r = requests.get(url)
